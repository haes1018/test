...
// ST2550사용시 외부 인터럽트시 호출 되는 함수
void EXTI0_INT( void )
{
	ST2550_Int( COMM_2G_LTE, SCC_UART1_CS1_ADDR ); // ST2550 인터럽트 처리 루틴
}
void EXTI1_INT( void )
{
	ST2550_Int( COMM_LTEA01, SCC_UART1_CS2_ADDR ); // ST2550 인터럽트 처리 루틴
}
...
//>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
// 각 시리얼 포트의 포트 설정, 주소설정, 속도 설정, 처리함수 설정...
//>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
